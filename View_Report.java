...
public class View_Report extends JPanel 
{
	...
	View_Report() {
		...
		tabbedPane.add("",new Product_Report());
		tabbedPane.add("",new Sales_Report());
		tabbedPane.add("",new Employee_Report());
		tabbedPane.add("",new Stock_Report());
		tabbedPane.add("",new Employee_Expense_Report());
		tabbedPane.add("",new Purchase_Expense_Report());
