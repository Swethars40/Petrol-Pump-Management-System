...
public class Sales_Entry extends JPanel implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		Sales_JavaBean ob = new Sales_JavaBean();
		...
		{
			Sales_Entry_Connection ob1 = new Sales_Entry_Connection();
