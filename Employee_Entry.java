...
public class Employee_Entry extends JPanel implements ActionListener
{
		...
		{	
			...
			public void focusLost(FocusEvent e)
			{
				...
				{			
			        ...
			        String q1  = "select branch_id, branch_name, emp_name, city, phone_no, date_of_joining, age, qualification, job, status, days, initial_salary, daily_wages from Employee_Entry where emp_id=?";
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(obj==btn_add)
		{
			...
			try
			{
				Employee_JavaBean etb = new Employee_JavaBean();
				...
				Employee_Entry_Connection jd = new Employee_Entry_Connection();
		...
		if(obj==btn_update)
		{
		  ...
		  // Date date2 = (Date)date_picker_cd.getDate();
			...
			try
			{
		        ...
		        String q2 = "update Employee_Entry set branch_id=?, branch_name=?, emp_name=?, city=?, phone_no=?, age=?, qualification=?, job=?, status=?, days=?, initial_salary=?, daily_wages=? where emp_id=?";
